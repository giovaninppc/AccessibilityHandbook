...
enum GameStates {
  ...
  @Stored(key: GameKeys.theUpsideDown, default: false)
  static var theUpsideDownCompleted: Bool
  ...
  @Stored(key: GameKeys.anAlternative, default: false)
  static var anAlternativeCompleted: Bool
}
